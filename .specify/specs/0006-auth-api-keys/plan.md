# 0006-auth-api-keys - Implementation Plan

## Architecture Design

```
ApiKeysController
  → POST /api/0006-auth-api-keys → ApiKeyGenerateCommand
  → GET /api/0006-auth-api-keys → ApiKeyGetListQuery
  → DELETE /api/0006-auth-api-keys/{id} → ApiKeyRevokeCommand
```
