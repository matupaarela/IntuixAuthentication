...
- [ ] POST /api/mfa/enable returns TOTP secret and QR URL
- [ ] POST /api/mfa/verify-setup verifies TOTP code and activates MFA
- [ ] POST /api/mfa/disable disables MFA (requires password)
